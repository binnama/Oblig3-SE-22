...
public class Test_LeapYear {
    ...
    public void Test_dividible_with_4_but_not_100(int year) {
        assertEquals(true, Main.isLeapYear(year));
    }

    @ParameterizedTest
    @ValueSource(ints = {2004, 2064})
    public void Test_dividible_with_400(int year) {
        assertEquals(true, Main.isLeapYear(year));
    ...
    public void Test_not_divible_with_4(int year) {
        assertEquals(false, Main.isLeapYear(year));
    }

    @ParameterizedTest
    @ValueSource(ints  = {1700, 1800, 1900, 2100})
    public void Test_dividible_with_100_but_not_400(int year) {
        assertEquals(false, Main.isLeapYear(year));
